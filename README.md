...
NeKoRoPIE is a secure, horizontally-scalable, and unopinionated Python backend that can handle REST and WebSocket endpoints, and even database querying and other operations.
